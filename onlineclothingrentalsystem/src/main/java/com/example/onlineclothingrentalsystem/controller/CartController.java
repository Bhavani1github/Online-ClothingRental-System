...
public class CartController {
	...
	//to add carts
		@PostMapping("{userId}/{pId}")
		public ResponseEntity<Cart> addCart(@Valid @RequestBody Cart cart, @PathVariable long pId,@PathVariable long userId) {
			System.out.println("********");
			return new ResponseEntity<Cart>(cartService.addCart(cart, pId,userId), HttpStatus.CREATED);
		}
